...
const Home = () => {
  ...
  return (
    <div className="bg-fixed bg-center bg-cover" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}>
      ...
      <div className="bg-black bg-opacity-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <Link 
                    to="/features" 
                    className="px-8 py-3 border-2 border-white text-white font-bold rounded-lg shadow-lg hover:bg-green-600 transition-colors text-center"
                  >
                    Learn More
                  </Link>
                </div>
        ...
        {/* Benefits Section */}
        <section className="py-16 bg-green-50 bg-opacity-90">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
